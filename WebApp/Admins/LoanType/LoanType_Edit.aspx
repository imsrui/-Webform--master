<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/shared/_Backend.Master" AutoEventWireup="true" CodeBehind="LoanType_Edit.aspx.cs" Inherits="WebApp.Admins.LoanType.LoanType_Edit" %>
        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">编辑贷款类型</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div>
                        <label>类型图片:</label>
                        <img src='../../upload/loantype/<%=imgUrl %>'/>
